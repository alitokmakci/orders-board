...
const showToast = (html, text, duration = 5000) => {
	html = `
		<div class="flex items-center p-4 mb-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow-lg dark:text-gray-400 dark:bg-gray-800" role="alert">
			${html}
			<div class="ml-3 text-sm font-medium select-none">${text}</div>
		</div>
	`
